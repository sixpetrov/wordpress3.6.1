...
$row_layout = array(
    ...
    "value" => array("" => "", "Two columns" => "two_columns", "Three columns" => "three_columns", "Four columns" => "four_columns"),
    "description" => "Choose one of these value, if you want content in this row to be shown in multiple columns. This will use CSS3 column-count property"
);

//$row_checkboxes = array(
//    "type" => "checkbox",
//    "heading" => "Predefined CSS classes (Row)",
//    "param_name" => "pre_css",
//    "value" => array("Bottom margin" => "vcsp_row_margin_bottom", "Three columns" => "three_columns"),
//    "description" => ""
//);

//$col_checkboxes = array(
//    "type" => "checkbox",
//    "heading" => "Predefined CSS classes (Column)",
//    "param_name" => "pre_css",
//    "value" => array("Bottom margin" => "vcsp_col_margin_bottom"),
//    "description" => ""
//);
...
$wpsp_vc_options = get_option('wpb_js_custom_css_classes');
$wpsp_vc_options = explode("\n", $wpsp_vc_options);

foreach($wpsp_vc_options as $option) {
    $option = trim($option);
    $option = explode(": ", $option);
    $custom_css_classes[$option[0]] = $option[1];
}

$predefined_css = array(
    "type" => "checkbox",
    "heading" => "Predefined CSS classes",
    "param_name" => "pre_css",
    "value" => $custom_css_classes,
    "description" => ""
);
...
---------------------------------------------------------- */
vc_map( array(
    "name" => __("Simple title", "js_composer"),
    "base" => "vc_simple_title",
    ...
    "params" => array(
        array(
            ...
            "description" => __("Simple title.", "js_composer")
        ),
        array(
            "type" => "dropdown",
            "heading" => __("Choose HTML tag", "js_composer"),
            "param_name" => "title_html_tag",
            "value" => array("p" => "p", "h1" => "h1", "h2" => "h2", "h3" => "h3", "h4" => "h4", "h5" => "h5",),
            "description" => __("Select which html will be used.", "js_composer")
        ),
        array(
            "type" => "dropdown",
            "heading" => __("Title position", "js_composer"),
            "param_name" => "title_align",
            "value" => array(__('Align left', "js_composer") => "separator_align_left", __('Align center', "js_composer") => "separator_align_center", __('Align right', "js_composer") => "separator_align_right"),
...
vc_map( array(
  ...
  "params" => array(
    ...
    array(
      ...
      "param_name" => "grid_read_more",
      "description" => __('Enter the text. Leave blank to disable.', "js_composer")
    ),
    array(
      "type" => "dropdown",
      "heading" => __("Link target", "js_composer"),
    ...
    array(
      "type" => "textfield",
      "heading" => __("Number of characters in Excerpt", "js_composer"),
      "param_name" => "excerpt_amount",
    ...
    array(
      ...
      "value" => array("Simple layout" => "simple_layout", __("Grid", "js_composer") => "grid", __("Grid with filter", "js_composer") => "filtered_grid", __("Carousel", "js_composer") => "carousel"),
      "description" => __("Teaser layout template.", "js_composer")
    ),
    array(
      "type" => "dropdown",
...
/* Quform */
if (is_plugin_active('iphorm-form-builder/iphorm-form-builder.php'))
{
    ...
    if (count($forms)) {
        foreach ($forms as $form) {
            $quforms[$form['name']] = $form['id'];
        }
    } else {
        $quforms["No contact forms found"] = 0;
    }
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            "type" => "attach_images",
            "heading" => __("Left Arrow", "js_composer"),
            "param_name" => "left_arrow",
            "value" => "",
            "description" => __("Choose left arrow control", "js_composer")
        ),
        array(
            "type" => "attach_images",
            "heading" => __("Right Arrow", "js_composer"),
            "param_name" => "right_arrow",
            "value" => "",
            "description" => __("Choose right arrow control", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Visible Images", "js_composer"),
            "param_name" => "images_visible",
            "description" => __("How many images will be visible. Default is 5", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Timeout", "js_composer"),
            "param_name" => "crs_timeout",
            "description" => __("Time in milliseconds. Default is 3000. Insert 0 to disable autoscroll.", "js_composer")
        ),
        array(
          "type" => "textfield",
          "heading" => __("Image size", "js_composer"),
