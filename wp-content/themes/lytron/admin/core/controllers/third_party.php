...
class aki_third_party
{
	...
	*/
	...
	{
		// only for aki
		if( $old_post_object->post_type != "aki" )
		{
			return;
		}
	...
	*/
	...
	{
		// get next id
		$next_id = (int) get_option('aki_next_field_id', 1);
