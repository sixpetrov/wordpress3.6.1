...
class aki_True_false extends aki_Field
{
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Message",'aki'); ?></label>
		<p class="description"><?php _e("eg. Show extra content",'aki'); ?></a></p>
	</td>
	<td>
		<?php 
